...
if [[ $arg1 = 'release' ]]; then
  ...
  sudo apt-get update
  sudo apt-get install wajig alien rpm lsb-base dpkg-dev debhelper build-essential libc6
  ...
  #url="https://root.marklogic.com/nightly/builds/linux64/rh6v-intel64-90-test-1.marklogic.com/HEAD/pkgs.$day/$fname"
  url="https://root.marklogic.com/nightly/builds/linux64-rh7/rh7v-intel64-90-test-build.marklogic.com/HEAD/pkgs.$day/$fname"
  echo "$url"
